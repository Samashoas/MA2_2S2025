...
print("x(t) = -t para -pi <= t < 0")
print("x(t) = t para 0 <= t <= pi")
print("Período T = 2*pi")
...
print("La serie debería ser de la forma: suma de bn*sin(nt) donde bn = 4/(n²*pi) para n impar")
